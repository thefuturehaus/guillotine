...
(function() {
  ...
  Guillotine = (function() {
    ...
    Guillotine.prototype._setZoom = function(factor) {
      return this._zoom(factor / this.data.scale);
    };
    ...
    Guillotine.prototype._rotate = function(angle) {
      var canvasRatio, glltRatio, h, ref, ref1, ref2, w;
      if (!canTransform()) {
        return;
      }
      ...
      if (angle % 180 !== 0) {
        ...
        ref = [this.height * glltRatio, this.width / glltRatio], this.width = ref[0], this.height = ref[1];
        if (this.width >= 1 && this.height >= 1) {
      ...
      ref1 = [1, 1], w = ref1[0], h = ref1[1];
      if (this.angle % 180 !== 0) {
        canvasRatio = this.height / this.width * glltRatio;
        ref2 = [canvasRatio, 1 / canvasRatio], w = ref2[0], h = ref2[1];
      }
    ...
    Guillotine.prototype.setZoom = function(z) {
      return this.enabled && (this._setZoom(z), this._trigger(z > this.data.scale ? 'zoomIn' : 'zoomOut'));
    };
